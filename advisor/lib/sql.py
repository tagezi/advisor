    ...
    *Methods*
    ...
    def get_bonds_by_value(self,
        ...
        sQuery = (
            ...
            "BondsSecurities.COUPONPERCENT, BondsSecurities.COUPONVALUE, "
            "BondsSecurities.ACCRUEDINT, BondsSecurities.NEXTCOUPON, "
            "BondsSecurities.COUPONPERIOD, BondDescription.INITIALFACEVALUE, "
            "BondDescription.FACEVALUE, BondDescription.FACEUNIT, "
            "BondsSecurities.LISTLEVEL, BondDescription.EMITTER "
        ...
        sQuery = (f"{sQuery} AND BondsSecurities.SECNAME not like \"%ОФЗ-АД%\" "
                  "AND BondsSecurities.SECNAME not like \"%ОФЗ-ПК%\" ")

        if bIN:
            sQuery = f" {sQuery} AND BondsSecurities.SECNAME like \"%ОФЗ-ИН%\" "
        else:
            sQuery = (f" {sQuery} AND BondsSecurities.SECNAME not like "
                      f"\"%ОФЗ-ИН%\" ")
    ...
    def get_period_list(self,
        ...
        lAnswer = self.execute_query(
            "select distinct BondsSecurities.COUPONPERIOD "
            "FROM BondsSecurities "
            "JOIN BondDescription "
            "ON BondDescription.SECID=BondsSecurities.SECID "
            ...
            "AND BondsSecurities.PREVPRICE is not NULL "
            "AND BondsSecurities.COUPONPERCENT > 1 "
            f"AND BondsSecurities.MATDATE > \"{sMatDateStart}\" "
            f"AND BondsSecurities.COUPONPERIOD<={int(iMaxPeriod)} "
            f"AND BondsSecurities.COUPONPERIOD<={int(iMaxPeriod)} "
            "AND BondDescription.INITIALFACEVALUE=BondDescription.FACEVALUE "
            "AND BondDescription.EMITTER not like \"%икрофинансовая%\" "
    ...
    def get_bond_by_value(self, sSECID):
        lAnswer = self.execute_query(
            "SELECT BondsSecurities.SHORTNAME, "
            "BondsSecurities.SECNAME, BondDescription.EMITTER, "
            "BondsSecurities.BOARDNAME, BondDescription.LISTLEVEL, "
            "BondDescription.SECID, BondDescription.ISIN, "
            "BondDescription.ISQUALIFIEDINVESTORS, BondsSecurities.ISSUESIZE, "
            "BondsSecurities.ISSUESIZEPLACED, BondsSecurities.LOTSIZE, "
            "BondsSecurities.DECIMALS, BondsSecurities.MINSTEP, "
            "BondDescription.INITIALFACEVALUE, BondDescription.FACEVALUE, "
            "BondsSecurities.LOTVALUE, BondsSecurities.FACEVALUEONSETTLEDATE, "
            "BondDescription.FACEUNIT, BondsSecurities.CURRENCYID, "
            "BondsSecurities.COUPONPERCENT, BondsSecurities.COUPONVALUE, "
            "BondsSecurities.ACCRUEDINT, BondsSecurities.COUPONPERIOD, "
            "BondsSecurities.NEXTCOUPON, BondsSecurities.MATDATE, "
            "BondsSecurities.OFFERDATE, BondsSecurities.BUYBACKPRICE, "
            "BondsSecurities.BUYBACKDATE, BondsSecurities.PREVWAPRICE, "
            "BondsSecurities.YIELDATPREVWAPRICE, BondsSecurities.PREVPRICE, "
            "BondsSecurities.PREVLEGALCLOSEPRICE, BondsSecurities.PREVDATE, "
            "BondsSecurities.REMARKS, BondsSecurities.SETTLEDATE, "
            "BondsSecurities.CALLOPTIONDATE, BondsSecurities.PUTOPTIONDATE, "
            "BondsSecurities.DATEYIELDFROMISSUER, BondsMarketData.PRICE, "
            "BondsMarketData.YIELDDATE, BondsMarketData.YIELDDATETYPE, "
            "BondsMarketData.EFFECTIVEYIELD, BondsMarketData.DURATION, "
            "BondsMarketData.ZSPREADBP, BondsMarketData.GSPREADBP, "
            "BondsMarketData.WAPRICE, "
            "BondsMarketData.EFFECTIVEYIELDWAPRICE, "
            "BondsMarketData.DURATIONWAPRICE, BondsMarketData.IR, "
            "BondsMarketData.ICPI, BondsMarketData.BEI, "
            "BondsMarketData.CBR, BondsMarketData.YIELDTOOFFER, "
            "BondsMarketData.YIELDLASTCOUPON, BondsMarketData.ZCYCMOMENT, "
            "BondsMarketData.TRADEMOMENT "
            "FROM BondDescription "
            "JOIN BondsSecurities "
            "ON BondDescription.SECID=BondsSecurities.SECID "
            "JOIN BondsMarketData "
            "ON BondDescription.SECID=BondsMarketData.SECID "
