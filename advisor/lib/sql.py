    ...
    *Methods*
    ...
    def get_bond_by_value(self, sSECID):
        lAnswer = self.execute_query(
            ...
            " BordSecurities.SECNAME, "
            "BondDescription.EMITTER, "
            "BordSecurities.BOARDNAME, "
            "BondDescription.LISTLEVEL, "
            "BondDescription.SECID, "
            "BondDescription.ISIN, "
            "BondDescription.ISQUALIFIEDINVESTORS, "
            "BordSecurities.ISSUESIZE, "
            "BordSecurities.ISSUESIZEPLACED, "
            "BordSecurities.LOTSIZE, "
            "BordSecurities.DECIMALS, "
            "BordSecurities.MINSTEP, "
            "BondDescription.INITIALFACEVALUE, "
            "BondDescription.FACEVALUE, "
            "BordSecurities.LOTVALUE, "
            "BordSecurities.FACEVALUEONSETTLEDATE, "
            "BondDescription.FACEUNIT, "
            "BordSecurities.CURRENCYID, "
            "BordSecurities.COUPONPERCENT, "
            "BordSecurities.COUPONVALUE, "
            "BordSecurities.ACCRUEDINT, "
            "BordSecurities.COUPONPERIOD, "
            "BordSecurities.NEXTCOUPON, "
            "BordSecurities.MATDATE, "
            "BordSecurities.OFFERDATE, "
            "BordSecurities.BUYBACKPRICE, "
            "BordSecurities.BUYBACKDATE, "
            "BordSecurities.PREVWAPRICE, "
            "BordSecurities.YIELDATPREVWAPRICE, "
            "BordSecurities.PREVPRICE, "
            "BordSecurities.PREVLEGALCLOSEPRICE, "
            "BordSecurities.PREVDATE, "
            "BordSecurities.REMARKS, "
            "BordSecurities.SETTLEDATE, "
            "BordSecurities.CALLOPTIONDATE, "
            "BordSecurities.PUTOPTIONDATE, "
            "BordSecurities.DATEYIELDFROMISSUER, "
            "MarketDataYields.PRICE, "
            "MarketDataYields.YIELDDATE, "
            "MarketDataYields.YIELDDATETYPE, "
            "MarketDataYields.EFFECTIVEYIELD, "
            "MarketDataYields.DURATION, "
            "MarketDataYields.ZSPREADBP, "
